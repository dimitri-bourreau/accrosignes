...
export default function Footer() {
  return (
    <footer className="px-6 py-12 bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <Title level="h4" className="text-gray-900 dark:text-gray-100 mb-4">
              Navigation
            </Title>
