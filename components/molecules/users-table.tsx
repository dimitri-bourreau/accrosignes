...
export function UsersTable({ adminId }: UsersTableProps) {
  ...
  const handleSetRole = (
    uid: string,
    currentRole: 'Administrateur' | 'Élève' | null,
  ) => {
    const newRole =
      currentRole === 'Administrateur' ? 'Élève' : 'Administrateur';
          ...
          >
            ...
            <td className="px-6 py-3 text-sm">
              <div className="flex items-center gap-3">
                <span className="text-xs font-semibold text-gray-700 dark:text-gray-200 w-10">
                  Admin
                </span>
                <button
                  ...
                  style={{
                    backgroundColor:
                      user.role === 'Administrateur' ? '#2563eb' : '#16a34a',
                  }}
                >
                  <div
