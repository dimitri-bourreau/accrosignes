...
export default function SocialLinksSection({ embedded }: SocialLinksSectionProps) {
  const content = (
    <div className={embedded ? "space-y-6 text-center" : "max-w-5xl mx-auto space-y-6 text-center"}>
  ...
  return (
    <section className="px-6 py-20 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
      {content}
    </section>
  );
}
